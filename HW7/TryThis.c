...
You can use this code with the text file you provided earlier. Just make sure the file is named "data.txt" and is located in the same directory as the program.
